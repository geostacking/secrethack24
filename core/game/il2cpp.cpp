...
// create global definition for il2mgr class.
c_il2mgr g_il2mgr;
...
uintptr_t c_il2mgr::init_class( const char* name, const char* name_space )
{
...
uintptr_t c_il2mgr::type_object( const char* name_space, const char* name )
{
	uintptr_t this_class = init_class( name, name_space );
	return methods::type_get_object( methods::class_get_type( this_class ) );
}

uintptr_t c_il2mgr::method( std::string kl, std::string name, int param_count, const char* name_space, bool param_check, int param_idx, std::string param_name )
{
...
uintptr_t c_il2mgr::hook( void* our_func, std::string kl, std::string name, int arg, const char* name_space )
{
...
uintptr_t c_il2mgr::hook_virt( const char* classname, const char* function_to_hook, void* our_func, int param_count, const char* name_space )
{
...
#ifdef log
			std::cout << "hooked: class_name " << classname << "|" << function_to_hook << std::endl;
#endif
			return addr;
		}
	}
...
uintptr_t c_il2mgr::field( uintptr_t this_class, const char* name )
{
	return methods::class_get_field_from_name( this_class, name );
}

uintptr_t c_il2mgr::value( const char* kl, const char* name, bool get_offset, const char* name_space )
{
