...
void c_aimbot::update_weapon_information( )
{
	...
	weapon_information bullet_info = held_item->get_weapon_information( );

    float bullet_velocity_scale = held_item->get_projectile_velocity_scale( false );
...
void c_aimbot::process( ) {
    ...
    bone_position = target->get_bone_position( aimbot_bone );
