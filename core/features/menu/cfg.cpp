...
void c_cfg_sys::save_cfg( const std::string& filename ) {
	...
	cfg_file << xs( "hit_sound_volume " ) << options::aimbot::hit_sound_volume << std::endl;
	cfg_file << xs( "hit_sound " ) << options::aimbot::hit_sound << std::endl;
	cfg_file << xs( "sound_type " ) << options::aimbot::sound_type << std::endl;
	...
	cfg_file << xs( "use_max_view " ) << options::aimbot::exploits::misc::use_max_view << std::endl;

	cfg_file << xs( "visible_manipulation " ) << options::aimbot::visible_manipulation << std::endl;
	cfg_file << xs( "auto_fire_type " ) << options::aimbot::auto_fire_type << std::endl;

	cfg_file << xs( "visualize_manipulation " ) << options::aimbot::visualize_manipulation << std::endl;
	cfg_file << xs( "generate_points " ) << options::aimbot::generate_points << std::endl;
	cfg_file << xs( "use_half_points " ) << options::aimbot::use_half_points << std::endl;
	cfg_file << xs( "use_max_eye_points " ) << options::aimbot::use_max_eye_points << std::endl;
	cfg_file << xs( "manipulation_angles " ) << options::aimbot::manipulation_angles << std::endl;

	cfg_file << xs( "overriden_hitbox " ) << options::aimbot::exploits::combat::overriden_hitbox << std::endl;
	cfg_file << xs( "override_hitbox " ) << options::aimbot::exploits::combat::override_hitbox << std::endl;
...
void c_cfg_sys::load_cfg( const std::string& filename ) {
	...
	while ( std::getline( cfg_file, line ) ) {
		...
		if( string_str >> feature_name ) {
			...
			if( feature_name == xs( "sound_type" ) ) string_str >> options::aimbot::sound_type;
			if( feature_name == xs( "hit_sound" ) ) string_str >> options::aimbot::hit_sound;
			if( feature_name == xs( "hit_sound_volume" ) ) string_str >> options::aimbot::hit_sound_volume;
			...
			if( feature_name == xs( "visualize_manipulation" ) ) string_str >> options::aimbot::visualize_manipulation;
			if( feature_name == xs( "generate_points" ) ) string_str >> options::aimbot::generate_points;
			if( feature_name == xs( "use_half_points" ) ) string_str >> options::aimbot::use_half_points;
			if( feature_name == xs( "use_max_eye_points" ) ) string_str >> options::aimbot::use_max_eye_points;
			if( feature_name == xs( "manipulation_angles" ) ) string_str >> options::aimbot::manipulation_angles;

			if( feature_name == xs( "overriden_hitbox" ) ) string_str >> options::aimbot::exploits::combat::overriden_hitbox;
			if( feature_name == xs( "override_hitbox" ) ) string_str >> options::aimbot::exploits::combat::override_hitbox;
			...
			if( feature_name == xs( "visible_manipulation" ) ) string_str >> options::aimbot::visible_manipulation;
			if( feature_name == xs( "auto_fire_type" ) ) string_str >> options::aimbot::auto_fire_type;
			if( feature_name == xs( "use_max_view" ) ) string_str >> options::aimbot::exploits::misc::use_max_view;
