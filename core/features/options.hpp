...
namespace options {
	...
	namespace visuals {
		...
		namespace world {
			...
			inline bool show_ammo_nails_arrows{ }, show_raid{ };
	...
	namespace aimbot {
		inline bool aim_check{ },
			...
			manipulation{ }, visible_manipulation{ }, kill_aura{ }, auto_reload{ }, ignore_melee{ true }, bullet_tp{ },
			aim_nearest_bone{ true }, visualize_manipulation{ }, generate_points{ }, use_half_points{ }, use_max_eye_points{ }, bullet_tp_mounted{ };

		inline bool hit_sound{ };
		inline int sound_type{ };
		inline float hit_sound_volume{ };
		...
		inline int aim_bone{ }, manipulation_key{ 1 }, aim_type{ 2 }, smooth_type{ },
			max_target_distance{ 750 }, fov_amount{ 150 }, manipulation_angles{ }, auto_fire_type{ 0 };
		...
		namespace exploits {
			...
			namespace combat {
				...
				inline int bullet_speed{ 50 }, overriden_hitbox{ 1 };
			}
			namespace time {
